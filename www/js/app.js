...
const apiUrl = 'https://simkes.rsbhayangkaranganjuk.com/api/'; // API Server URL
const website_upload = 'https://simkes.rsbhayangkaranganjuk.com/uploads/'; // Website Uploads Server URL
const webapps_url = 'https://simrs.rsbhayangkaranganjuk.com/webapps/'; // Webapps Server URL
